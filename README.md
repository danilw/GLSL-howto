...
**Float precision on GPU, bugs/features** (https://arugl.medium.com/float-precision-on-gpu-bugs-features-178ddd030f)[medium blog post link], info about float bits on GPU.
